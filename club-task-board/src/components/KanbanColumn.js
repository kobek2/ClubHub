...
const KanbanColumn = ({ title, status, tasks, currentUser, moveTaskStatus, events, meetings }) => (
    <div className="flex-1 bg-gray-50 rounded-xl p-4 min-w-[280px]">
      ...
      <div className="space-y-2">
        {tasks.map(t => ( // <-- Mapping starts here
            // ✅ This is the ONLY TaskCard rendering you need.
            <TaskCard 
                key={t.id} 
                task={t} 
