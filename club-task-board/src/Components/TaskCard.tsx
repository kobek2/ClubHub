...
const TaskCard: React.FC<TaskCardProps> = ({ task, currentUser, moveTaskStatus, events, meetings }) => {
  ...
  const StatusPicker: React.FC<{ currentStatus: TaskStatus }> = ({ currentStatus }) => {
